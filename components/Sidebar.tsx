  ...
  return (
    <aside className="bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-white w-64 p-4 flex flex-col h-screen border-r border-gray-200 dark:border-gray-700/50">
      ...
      <div className="mt-4 pt-4 border-t border-gray-200 dark:border-gray-700/50 space-y-2">
        ...
        <button
          onClick={onShowHelp}
          className="w-full flex items-center justify-center gap-2 text-sm text-indigo-600 dark:text-indigo-400 hover:bg-indigo-100 dark:hover:bg-indigo-500/10 font-semibold py-2 px-3 rounded-lg transition-colors duration-200"
        >
          Help & Documentation
        </button>
        <button
